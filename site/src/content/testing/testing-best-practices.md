...
section: testing
description: "Хороший тест — это не тот, который проходит, а тот, который **ловит ошибки, читается как документация и не ломается при рефакторинге**."
order: 5
tags: ["лучшие", "практики", "тестирования", "фронтенда"]
questions:
