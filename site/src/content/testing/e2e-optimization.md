...
section: testing
description: "E2E-тесты дают максимальную уверенность, но могут превратить CI в марафон. Если прогон E2E занимает 40 минут, разработчики начинают обходить CI, а тесты теряют ценность."
order: 1
tags: ["оптимизация", "ускорение", "e2e-тестов"]
questions:
