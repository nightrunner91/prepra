---
title: "GraphQL vs REST: Полное руководство для Frontend-разработчика"
section: api-communication
description: "При построении API разработчики выбирают между REST и GraphQL. В этой статье разберём обе технологии, их преимущества, недостатки и сценарии использования. Особое внимание уделим GraphQL."
order: 1
tags: ["graphql", "rest", "полное", "руководство", "frontend-разработчика"]
---
