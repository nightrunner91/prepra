---
title: "Web Workers — вынос тяжёлых вычислений из основного потока"
section: performance
description: "Web Workers — это механизм, позволяющий выполнять JavaScript-код в **фоновом потоке**, не блокируя основной поток, в котором работает UI. Когда приложение выполняет ресурсоёмкие вычисления (обработ..."
order: 6
tags: ["web", "workers", "вынос", "тяжёлых", "вычислений"]
---
