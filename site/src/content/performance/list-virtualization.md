---
title: "Виртуализация списков — Глубокое погружение"
section: performance
description: "1. [Что такое виртуализация списков](#что-такое-виртуализация-списков)"
order: 3
tags: ["виртуализация", "списков", "глубокое", "погружение"]
---
