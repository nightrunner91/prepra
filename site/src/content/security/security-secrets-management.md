---
title: "Управление секретами во фронтенде: от .env до Vault"
section: security
description: "1. [Что такое секрет и почему фронтенд — не надёжное хранилище](#что-такое-секрет-и-почему-фронтенд--не-надёжное-хранилище)"
order: 7
tags: ["управление", "секретами", "фронтенде", "env", "vault"]
---
