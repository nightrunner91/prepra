---
title: "Продвинутая оптимизация бандла — от анализа до реальных результатов"
section: build-and-deployment
description: "1. [Почему размер бандла имеет значение](#почему-размер-бандла-имеет-значение)"
order: 1
tags: ["продвинутая", "оптимизация", "бандла", "анализа", "реальных"]
---
