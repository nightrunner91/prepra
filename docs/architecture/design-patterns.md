---
title: "Паттерны проектирования и структура файлов в React / Next.js"
section: architecture
description: "Паттерны проектирования и структура файлов в React / Next.js"
order: 2
tags: ["паттерны", "проектирования", "структура", "файлов", "react"]
---
