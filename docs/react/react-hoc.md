---
title: "Higher-Order Components (HOC) — глубокое погружение"
section: react
description: "Higher-Order Component (HOC, компонент высшего порядка) — один из классических паттернов React для переиспользования логики между компонентами. HOC — это **функция, которая принимает компонент и во..."
order: 5
tags: ["higher-order", "components", "hoc", "глубокое", "погружение"]
---
