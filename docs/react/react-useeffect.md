---
title: "React `useEffect` — Глубокое погружение"
section: react
description: "useEffect — хук для побочных эффектов в React: API-запросы, подписки, работа с DOM, таймеры. Разбор механики, массива зависимостей, cleanup-функции и сравнение с Vue."
order: 14
tags: ["react", "useeffect", "глубокое", "погружение"]
---
