---
title: "Сборка и CI/CD — от бандлеров до автоматизации деплоя"
section: build-and-deployment
description: "1. [Почему фронтендеру нужно понимать сборку](#почему-фронтендеру-нужно-понимать-сборку)"
order: 2
tags: ["сборка", "cicd", "бандлеров", "автоматизации", "деплоя"]
---
