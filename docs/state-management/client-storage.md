---
title: "Локальные хранилища данных — глубокое погружение"
section: state-management
description: "1. [Что такое клиентское хранилище и зачем оно нужно](#что-такое-клиентское-хранилище-и-зачем-оно-нужно)"
order: 1
tags: ["локальные", "хранилища", "данных", "глубокое", "погружение"]
---
