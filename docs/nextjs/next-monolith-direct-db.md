---
title: "Next.js как монолит: прямое обращение к базе данных без отдельного API"
section: nextjs
description: "Next.js App Router позволяет строить полноценные приложения, где серверные компоненты и Server Actions обращаются к базе данных напрямую — без отдельного REST/GraphQL API-слоя. Этот документ деталь..."
order: 5
tags: ["nextjs", "монолит", "прямое", "обращение", "базе"]
---
