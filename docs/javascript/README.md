...
Раздел углубляет понимание языка: как JS хранит данные, как работает область видимости, замыкания, `this`, прототипы, Event Loop и продвинутые возможности.

## Начни с базы

Если ты только знакомишься с JavaScript или хочешь закрыть пробелы:

1. **[Основы JavaScript](./javascript-fundamentals.md)** — переменные, типы данных, функции, объекты, массивы, DOM, события, асинхронность. Самая база для начинающих.
2. **[Типы данных и приведение типов](./js-data-types.md)** — примитивы и объекты, `typeof`, coercion, `==`/`===`, `Object.is`, `Number.isNaN`, собеседовательские ловушки.
...
- **[Алгоритмическая сложность и Big O](./js-big-o.md)** — типы сложностей, пространственная сложность, шпаргалка, типичные задачи с собеседований, паттерны оптимизации, встроенные структуры данных JS и их сложность.
