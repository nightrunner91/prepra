...
1. **[Основы тестирования](./testing-fundamentals.md)** — пирамида, Testing Trophy, FIRST, AAA, TDD.
...
- **[Лучшие практики тестирования](./testing-best-practices.md)** — FIRST, AAA, фабрики, POM, изоляция, селекторы.
