---
title: "Sentry: Полное руководство по интеграции и мониторингу"
section: testing
description: "1. [Что такое Sentry и зачем он нужен](#что-такое-sentry-и-зачем-он-нужен)"
order: 3
tags: ["sentry", "полное", "руководство", "интеграции", "мониторингу"]
---
