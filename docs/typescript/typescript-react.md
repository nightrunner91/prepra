...
questions:
  ...
  - "Какие типы событий использует React и как их типизировать"
  - "Как правильно типизировать `useState` с nullable начальным значением"
  - "Что такое discriminated unions и как они используются в `useReducer`"
